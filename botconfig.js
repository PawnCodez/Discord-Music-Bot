module.exports = {
  ...
  CookieSecret: "###############################################", // A cookie for you, cookie for me. make sure you change this value!
  IconURL:
  ...
  Lavalink: {
    id: "###############################################", //- Used for indentifier. You can set this to whatever you want.
    ...
    secure: ###############################################, // Set this to true if the lavalink uses SSL. if not set it to false.
